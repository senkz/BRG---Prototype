		...
		JPanel knoppenPanel = new JPanel();
			...
			writeFile.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent ae) 
				{
					...
					{
						//System.out.println(fileBrowser.getCurrentDirectory().toString()+fileBrowser.getSelectedFile().getName());
						File _file = new File(fileBrowser.getCurrentDirectory().toString()+fileBrowser.getSelectedFile().getName());
